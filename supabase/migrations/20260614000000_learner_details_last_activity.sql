-- Phase 3.5.1 — add lastActivityAt to get_learner_details
-- exam_attempts has submitted_at (no started_at column today).
-- Uses MAX(submitted_at) as the learner's most recent meaningful activity.
